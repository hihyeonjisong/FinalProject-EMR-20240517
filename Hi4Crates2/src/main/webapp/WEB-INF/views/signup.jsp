			...
			<div class="row justify-content-center align-items-center h-100">
				<div class="col-xxl-6 col-xl-7 col-lg-7 col-md-7 col-sm-8 col-12">
					<div class="p-5">
						...
						<p class="h5 fw-semibold mb-2">직원 회원가입</p>
						...
						<form action="/public/signup.do" method="post" id="signupForm" enctype="multipart/form-data">
							<div class="row gy-3">
								<div class="col-xl-12">
									<span class="avatar avatar-xxl avatar-rounded me-3"
										style="margin-left: 80px; height: 10rem; width: 10rem;">
										<img id="imgBox" src="${pageContext.request.contextPath }/resources/assets/images/faces/9.jpg"
										alt="">
									</span><br>
								</div>
								<div class="col-12">
									<label for="input-label" class="form-label">프로필사진</label> 
									<input type="file" class="form-control" style="width: 50%;" name="file"
										id="inputFile" value="">
								</div>
								<div class="col-xl-12 mb-3">
									<label for="signup-job" class="form-label text-default">직무</label>
									<select class="form-select form-select-lg" name="empJob"
								...
								<div class="col-xl-12 d-grid mt-2">
									<input type="submit" class="btn btn-lg btn-primary" id="signupBtn"
										value="회원 가입">
								</div>
							</div>
<%-- 							<sec:csrfInput /> --%>
