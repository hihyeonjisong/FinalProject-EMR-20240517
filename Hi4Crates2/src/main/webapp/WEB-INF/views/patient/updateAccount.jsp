			...
			<div class="row justify-content-center align-items-center h-100">
				<div class="col-xxl-6 col-xl-7 col-lg-7 col-md-7 col-sm-8 col-12">
					<div class="p-5">
						...
						<p class="h5 fw-semibold mb-2">회원정보 수정</p>
						...
						<form action="/pAccount/update.do" method="post" id="signupForm">
							<input type="hidden" name="memNo" value="${sessionScope.user.member.memNo }">
							<div class="row gy-3">
								<div class="col-xl-12 mt-0">
									<label for="signup-firstname" class="form-label text-default">이름</label>
									<input type="text" class="form-control form-control-lg" name="memName" id="memName" placeholder="이름" value="${memberVO.memName}">
								...
								<div class="col-xl-12">
									<label for="signup-tel" class="form-label text-default">휴대폰
										...
										id="memTel" name="memTel" placeholder="010-1234-5678" value="${memberVO.memTel}">
								...
								<div class="col-xl-12">
									<label for="signup-tel2" class="form-label text-default">추가
										...
										id="memAddtel" name="memAddtel" placeholder="선택사항" value="${memberVO.memAddtel}">
								</div>
								...
								<div class="col-xl-12">
									...
									<div class="input-group">
										<input type="text" class="form-control form-control-lg"
											id="memPostcode" name="memPostcode" placeholder="우편번호" value="${memberVO.memPostcode }">
								...
								<div class="col-xl-12">
									<label for="signup-add" class="form-label text-default">주소
										...
										id="memAddress1" name="memAddress1" placeholder="주소를 입력해주세요" value="${memberVO.memAddress1}">
								...
								<div class="col-xl-12">
									<label for="signup-add2" class="form-label text-default">상세
										...
										placeholder="상세 주소를 입력해주세요" value="${memberVO.memAddress2}">
								...
								<div class="col-xl-12 d-grid mt-2">
									<input type="button" class="btn btn-lg btn-primary1" id="signupBtn"
										value="수정하기" style="background-color: #7bd1f4;color: white;">
								</div>
							</div>
<!-- 							<sec:csrfInput /> -->
						</form>
